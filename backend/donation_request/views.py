        ...
        try:
            ...
            if role == 'donor':
                ...
                if donation_request.donor_approved is True:
                    return Response({'message':'Donation Request already fulfilled by Donor'}, status=status.HTTP_400_BAD_REQUEST)
                ...
                if donation_request.reciever_approved is True:
                    return Response({'message':'Donation Request already fulfilled by Receiver'}, status=status.HTTP_400_BAD_REQUEST)
                
                if donation_request.donor_approved is False:
                    return Response({'message':'Donation Request has not been fulfilled by Donor yet'}, status=status.HTTP_400_BAD_REQUEST)
