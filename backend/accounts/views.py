...
from .serializers import UserLoginSerializer, VerifyOtpSerializer, UpdateCoordinatesSerializer , UserProfileViewSerializer
...
class RegisterView(APIView):
    def post(self, request):
        ...
        try:
            user = User(email=email, adhaar_number=adhaar_number, phone=phone, address=address, first_name=first_name, last_name=last_name, date_of_birth=date_of_birth)
